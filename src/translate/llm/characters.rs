...
pub static CHARACTERS: LazyLock<Box<[Character]>> = LazyLock::new(|| Box::new([
    ...
    Character { jpspeaker: "玻ヰ璃[ハイリ]＝ラリック", enspeaker: "Hairi Lalique", gender: "Female", ..Default::default() },
    Character { jpspeaker: "カンパネラ", enspeaker: "Campanella", gender: "Unknown", ..Default::default() },
    Character { jpspeaker: "歌紫歌[カシカ]＝ガレ", enspeaker: "Kashika Galle", gender: "Male", ..Default::default() },
    Character { jpspeaker: "糸遠[シオン]＝ラリック", enspeaker: "Shion Lalique", gender: "Male", ..Default::default() },
    Character { jpspeaker: "衿栖[エリス]＝シュナイダー", enspeaker: "Eris Schneider", gender: "Female", ..Default::default() },
    Character { jpspeaker: "綸燈[リンドウ]＝ウェステリア", enspeaker: "Rindo Westeria", gender: "Male", ..Default::default() },
    Character { jpspeaker: "泣虎[ナトラ]＝ピオニー", enspeaker: "Natra Peony", gender: "Male", ..Default::default() },
    Character { jpspeaker: "廻螺[エラ]＝アマルリック", enspeaker: "Ela Amalric", gender: "Male", ..Default::default() },
    Character { jpspeaker: "憂漣[ユーレン]＝ミュラー", enspeaker: "Ulen Mueller", gender: "Male", ..Default::default() },
    Character { jpspeaker: "紫鳶[シエン]＝クリノクロア", enspeaker: "Shien Clinochlore", gender: "Male", ..Default::default() },
    Character { jpspeaker: "黒禰[クロネ]＝スピネル", enspeaker: "Klone Spinel", gender: "Male", ..Default::default() },
    ...
    Character { jpspeaker: "刈鐘[カリガネ]", enspeaker: "Karigane", gender: "Unknown", ..Default::default() },
    ...
    Character { jpspeaker: "晩歌[バンカ]", enspeaker: "Banka", gender: "Unknown", ..Default::default() },
    ...
    Character { jpspeaker: "瑠璃[ルリ]", enspeaker: "Ruri", gender: "Female", ..Default::default() },
]));
